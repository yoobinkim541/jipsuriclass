...
const servicePages: LandingPageDefinition[] = [
  {
    ...
    searchTerms: ["누수", "누수복구", "천장누수", "욕실누수", "배관누수", "물샘", "배관", "방수", "천장"],
  ...
  },
  {
    ...
    searchTerms: ["욕실", "화장실", "타일", "줄눈", "실리콘", "방수", "욕조", "세면대"],
  ...
  },
  {
    ...
    searchTerms: ["도배", "벽지", "부분도배", "원상복구", "벽", "도배지"],
  ...
  },
  {
    ...
    searchTerms: ["문수리", "문", "문틀", "경첩", "도어락", "현관문", "방문"],
  ...
  },
  {
    ...
    searchTerms: ["목공", "선반", "서랍", "몰딩", "걸레받이", "문틀", "수납", "붙박이"],
  ...
  },
  {
    ...
    searchTerms: ["방수", "방수보수", "옥상방수", "욕실방수", "베란다", "옥상", "탄성코트"],
  ...
  },
  {
    ...
    searchTerms: ["도장", "페인트", "벽면도장", "천장도장", "내부도장", "페인트칠", "도색", "벽"],
  ...
  },
  {
    ...
    searchTerms: ["창호", "샷시", "창문", "방충망", "단열", "창틀", "실리콘"],
  ...
  },
  {
    ...
    searchTerms: ["전기", "콘센트", "스위치", "전등", "누전", "조명", "LED", "형광등", "전선"],
  ...
  },
  {
    ...
    searchTerms: ["타일", "줄눈", "타일교체", "현관타일", "주방타일", "욕실타일", "세라믹"],
  ...
  },
  {
    ...
    searchTerms: ["배관", "수도", "누수", "막힘", "해빙", "변기", "수전", "하수", "동파", "온수", "설비", "상하수도"],
  ...
  },
  {
    ...
    searchTerms: ["인테리어필름", "필름", "싱크대필름", "문필름", "가구리폼", "시트지", "싱크대", "리폼"],
...
const areaPages: LandingPageDefinition[] = [
  ...
  },
  {
    ...
    searchTerms: ["고양", "일산", "고양시", "일산동구", "일산서구"],
