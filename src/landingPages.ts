...
const servicePages: LandingPageDefinition[] = [
  {
    ...
    searchTerms: ["누수", "누수복구", "천장누수", "욕실누수", "배관누수", "물샘", "배관", "방수", "천장", "석고보드", "누수피해", "아랫집", "보상"],
  ...
  },
  {
    ...
    searchTerms: ["욕실", "화장실", "타일", "줄눈", "실리콘", "방수", "욕조", "세면대", "욕실장", "샤워부스", "코킹", "환풍기", "곰팡이"],
  ...
  },
  {
    ...
    searchTerms: ["문수리", "문틀", "경첩", "도어락", "현관문", "방문", "중문", "중문수리", "고정핀", "안전고리", "디지털도어락", "문닫힘"],
  ...
  },
  {
    ...
    searchTerms: ["방수", "방수보수", "옥상방수", "욕실방수", "베란다", "옥상", "탄성코트", "코킹", "우레탄", "크랙", "균열", "방수실리콘", "탄성코팅"],
  ...
  },
  {
    ...
    searchTerms: ["창호", "샷시", "창문", "방충망", "단열", "창틀", "유리교체", "이중창", "로이유리", "모헤어", "알루미늄방충망", "미세망"],
  ...
  },
  {
    ...
    searchTerms: ["전기", "콘센트", "스위치", "전등", "누전", "조명", "LED", "형광등", "전선", "센서등", "환풍기", "기판", "모듈", "리모컨", "도어락"],
...
const areaPages: LandingPageDefinition[] = [
  {
    ...
    searchTerms: ["남양주", "화도읍", "마석", "진접", "별내", "평내", "이편한세상", "라온프라이빗", "화도", "녹촌", "금남"],
