...
const servicePages: LandingPageDefinition[] = [
  ...
  },
  {
    ...
    searchTerms: ["방수", "방수보수", "옥상방수", "욕실방수", "베란다"],
  ...
  },
  {
    ...
    searchTerms: ["도장", "페인트", "벽면도장", "천장도장", "내부도장"],
  ...
  },
  {
    ...
    searchTerms: ["타일", "줄눈", "타일교체", "현관타일", "주방타일"],
