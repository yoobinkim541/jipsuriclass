    ...
    <section className="landing-section section" aria-labelledby="estimator-title">
      ...
      <div className="estimator-layout">
                    ...
                    >
                      ...
                      {isSelected && isQuantityItem && (
                        <div
                          ...
                          style={{ display: "inline-flex", alignItems: "center", gap: 4, flexShrink: 0, border: "1px solid var(--hair,#e6dfd0)", borderRadius: 999, padding: 2, background: "var(--panel,#fff)" }}
                        >
                          <button
                            type="button"
        ...
        <div className="estimator-panel-col">
          <div style={{ background: "var(--panel,#fff)", border: "1px solid var(--hair,#e6dfd0)", borderRadius: 16, overflow: "hidden" }}>
